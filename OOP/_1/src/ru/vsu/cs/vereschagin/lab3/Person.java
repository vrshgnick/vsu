...
public class Person {
    ...
    static {
        System.out.println("Инициализация класса Person. Статический блок");
    }

    {
        System.out.println("Нестатический блок Person");
    }
    ...
    public Person(String personName, String personSurname, int personAge, String hobby) {
        ...
        this.personAge = personAge;
        this.hobby = hobby;
        System.out.println("Создается объект класса Person: " + personName + " " + personSurname + "\n");
    }
